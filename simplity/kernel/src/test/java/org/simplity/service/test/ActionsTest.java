...
public class ActionsTest extends Mockito {
  ...
  public static void setUp() throws Exception {
    ...
    when(dirfactory.getInitialContext(any(clazz)))
        .thenAnswer(
            new Answer<Context>() {
    ...
    when(mockContext.getAttributes("CN=Sunita Williams"))
        .thenAnswer(
            new Answer<Attributes>() {
              @Override
    ...
    when(mockContext.lookup("CN=Sunita Williams"))
        .thenAnswer(
            new Answer<Object>() {
    ...
    when(mockContext.getAttributes("CN=Sunita Williams", attrIDs))
        .then(
            new Answer<Attributes>() {
  ...
  public void LogicTest() {
    ...
    assertEquals(
        ((JSONObject) ((JSONArray) obj.get("weekendBoxOffice")).get(0)).get("Theaters"), "465");
