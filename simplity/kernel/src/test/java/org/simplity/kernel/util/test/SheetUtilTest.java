...
public class SheetUtilTest {
  ...
  public final void columnToListInteger() {
    ...
    actualList =
        (List<Integer>) dataSheet.columnAsCollection("customerNumber", actualList, Integer.class);
  ...
  public final void columnToListString() {
    ...
    actualList =
        (List<String>) dataSheet.columnAsCollection("customerName", actualList, String.class);
  ...
  public final void columnsToMap() {
    ...
    actualResult =
        dataSheet.columnsAsMap("city", "country", actualResult, String.class, String.class);
  ...
  public final MultiRowsSheet getSheet() {
    String[] columnNames = {
      "customerNumber", "customerName", "address", "city", "state", "country", "postalCode"
    };
    ValueType[] columnValueTypes = {
      ValueType.INTEGER,
      ValueType.TEXT,
      ValueType.TEXT,
      ValueType.TEXT,
    ...
    Value[] row1 = {
      Value.newIntegerValue(103),
      Value.newTextValue("Atelier graphique"),
      Value.newTextValue("54, rue Royale"),
      Value.newTextValue("Nantes"),
      Value.newTextValue("NULL"),
      Value.newTextValue("France"),
      Value.newIntegerValue(44000)
    };
    Value[] row2 = {
      Value.newIntegerValue(112),
      Value.newTextValue("Signal Gift Stores"),
      Value.newTextValue("8489 Strong St."),
      Value.newTextValue("Las Vegas"),
      Value.newTextValue("NV"),
      Value.newTextValue("USA"),
      Value.newIntegerValue(83030)
    };
    Value[] row3 = {
      Value.newIntegerValue(114),
      Value.newTextValue("Australian Collectors"),
      Value.newTextValue("636 St Kilda Road"),
      Value.newTextValue("Melbourne"),
      Value.newTextValue("Victoria"),
      Value.newTextValue("Australia"),
      Value.newIntegerValue(3004)
    };
    Value[] row4 = {
      Value.newIntegerValue(119),
      Value.newTextValue("La Rochelle Gifts"),
      Value.newTextValue("67, rue des Cinquante Otages"),
      Value.newTextValue("Nantes"),
      Value.newTextValue("NULL"),
      Value.newTextValue("France"),
      Value.newIntegerValue(4110)
    };
    Value[] row5 = {
      Value.newIntegerValue(121),
      Value.newTextValue("Baane Mini Imports"),
      Value.newTextValue("Erling Skakkes gate 78"),
      Value.newTextValue("San Rafael"),
      Value.newTextValue("CA"),
      Value.newTextValue("USA"),
      Value.newIntegerValue(97562)
    };
