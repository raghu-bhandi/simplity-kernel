...
public class Messages extends Message {
  ...
  /**
   * Custom stringification method for a given MimeMessage object. This is incomplete, more details
   * can be added, but this is all I needed.
   *
  ...
  public static String stringifyMimeMessage(MimeMessage message) throws Exception {
    ...
    messageBuilder
        .append("To:")
        .append(message.getRecipients(RecipientType.TO)[0].toString())
        .append("\n");
    ...
    messageBuilder.append(
        message.getContent() == null ? "No content" : message.getContent().toString());
